...
* [**1. Table of Contents**](#TOC)
    ...
    * [1.6 Neural Network Classification Weight Update](#1.6)
        ...
        * [1.6.2 Gradient Descent Algorithm with Very High Learning Rate and Low Epoch Count ](#1.6.2)
        * [1.6.3 Gradient Descent Algorithm with Very High Learning Rate and High Epoch Count](#1.6.3)
        * [1.6.4 Gradient Descent Algorithm with High Learning Rate and Low Epoch Count](#1.6.4)
        * [1.6.5 Gradient Descent Algorithm with High Learning Rate and High Epoch Count](#1.6.5)
        * [1.6.6 Gradient Descent Algorithm with Low Learning Rate and Low Epoch Count](#1.6.6)
        * [1.6.7 Gradient Descent Algorithm with Low Learning Rate and High Epoch Count](#1.6.7)
